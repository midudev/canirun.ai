...
const LICENSES: LicenseInfo[] = [
  ...
  {
    id: slug("FLUX Non-Commercial"),
    name: "FLUX Non-Commercial",
    fullName: "FLUX.2 Non-Commercial License",
    tier: "restricted",
    summary: "Black Forest Labs' non-commercial license for FLUX.2 Dev and Klein 9B. Weights are open for research and personal use; commercial use needs a separate agreement.",
    url: "https://bfl.ai",
    commercialUse: false,
    permissions: [
      "Research use — use freely for academic and research purposes",
      "Modification — fine-tune and adapt the model for non-commercial work",
      "Private use — generate and edit images for personal projects",
      "Evaluation — benchmark and compare against other image models",
    ],
    conditions: [
      "Non-commercial only — commercial products and hosted APIs need a license from Black Forest Labs",
      "License notice — include the license when redistributing weights or derivatives",
      "Acceptable use — must comply with Black Forest Labs' usage policy",
    ],
    limitations: [
      "Commercial use — not permitted without a separate commercial license",
      "Hosted services — paid or public generation APIs need BFL approval",
      "Trademark use — does not grant rights to FLUX or Black Forest Labs marks",
      "Liability — Black Forest Labs disclaims all liability",
      "Warranty — provided \"as is\" without warranty",
    ],
    note: "FLUX.2 Klein 4B is Apache 2.0. Contact Black Forest Labs for commercial licensing of Dev and Klein 9B.",
  },
  {
    id: slug("Tencent Hunyuan Community"),
    name: "Tencent Hunyuan Community",
    fullName: "Tencent Hunyuan Community License Agreement",
    tier: "restricted",
    summary: "Tencent's community license for HunyuanImage. Allows research and commercial use outside the EU, UK and South Korea, with an acceptable-use policy.",
    url: "https://huggingface.co/tencent/HunyuanImage-3.0/blob/main/LICENSE",
    commercialUse: true,
    permissions: [
      "Commercial use — allowed in the licensed territory",
      "Modification — fine-tune, distill and create derivative models",
      "Distribution — redistribute weights and derivatives with the license",
      "Private use — use for personal or internal projects",
    ],
    conditions: [
      "Territory — the license does not apply in the European Union, United Kingdom or South Korea",
      "Acceptable use — must follow Tencent's acceptable use policy",
      "License notice — include the license in redistributions",
      "Attribution — credit Tencent Hunyuan as the model creator",
    ],
    limitations: [
      "Geographic restriction — not licensed for use in the EU, UK or South Korea",
      "Harmful use — cannot use for illegal, harmful or deceptive purposes",
      "Trademark use — does not grant rights to Tencent trademarks",
      "Liability — Tencent disclaims all liability",
      "Warranty — provided \"as is\" without warranty",
    ],
    note: "Review the full Tencent Hunyuan Community License before production use, especially if you or your users are in the EU, UK or South Korea.",
  },
  {
    id: slug("LTX-2 Community"),
    name: "LTX-2 Community",
    fullName: "LTX-2 Community License Agreement",
    tier: "partial",
    summary: "Lightricks' community license for LTX-2. Commercial use is free under $10M annual revenue; larger companies need a paid agreement.",
    url: "https://huggingface.co/Lightricks/LTX-2.3/blob/main/LICENSE",
    commercialUse: true,
    permissions: [
      "Commercial use — free for organizations under $10M annual revenue",
      "Modification — fine-tune, adapt and create derivative models",
      "Distribution — redistribute weights and derivatives with the license",
      "Private use — generate video and audio for personal or internal projects",
    ],
    conditions: [
      "Revenue threshold — organizations at or above $10M ARR must obtain a commercial license from Lightricks",
      "License notice — include the license when redistributing weights or derivatives",
      "Acceptable use — must comply with Lightricks' usage restrictions",
    ],
    limitations: [
      "Large-scale commercial use — $10M+ ARR companies need a paid Lightricks license",
      "Trademark use — does not grant rights to LTX or Lightricks marks",
      "Liability — Lightricks disclaims all liability",
      "Warranty — provided \"as is\" without warranty",
    ],
    note: "Contact Lightricks for a Commercial Use Agreement if your organization exceeds the $10M revenue threshold.",
  },
];
